        ...
        <div className='HeroVisitContainer'>
            ...
            <div className='HeroVisitLeft'>
                <div className='HeroVisitContent'>
                    <div className='HeroVisitHeader'>
                        ...
                        <h2 className='HeroVisitTitle'>
                            Frontend Developer
                        </h2>
                        
                        <p className='HeroVisitDescription'>
                            Skapar moderna och engagerande webbupplevelser med fokus på användarvänlighet och design
                        </p>
                    </div>

                    <div className='HeroVisitContact'>
                        <div className='HeroContactItem'>
                            <svg className='HeroContactIcon' fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div className='HeroContactItem'>
                            <svg className='HeroContactIcon' fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className='HeroVisitRight'>
                ...
                <div className='HeroVisitScrollIndicator'>
                    ...
                    <svg className='HeroVisitScrollArrow' fill="none" stroke="currentColor" viewBox="0 0 24 24">
